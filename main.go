...
func init() {
	...
	_ = influxdbv1.AddToScheme(scheme)
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:   "86504420.influxdata.com",
	})
	if err != nil {
	...
	if err = (&controllers.InfluxDBReconciler{
		Client:   mgr.GetClient(),
		Log:      ctrl.Log.WithName("controllers").WithName("InfluxDB"),
		Recorder: mgr.GetEventRecorderFor("influxdb-controller"),
